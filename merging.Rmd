...
There are only 17 genes in our gene list but 55 in our merged file. If you inspect the merged list you also see that some of the Contig names are duplicated. We want to find the top hit with the lowest eval for each contig.
